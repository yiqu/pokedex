...
export const ITEM_SPRITE_API_URL = process.env.NEXT_PUBLIC_ITEM_SPRITE_API_URL;
...
export const POKE_API_URL = process.env.NEXT_PUBLIC_POKE_API_URL; //https://pokeapi.co/api/v2/